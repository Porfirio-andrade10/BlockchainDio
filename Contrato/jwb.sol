...
interface IERC20 {
    ...
    event Approval(address indexed owner, address indexed sender, uint256);
    
}

contract JWB is IERC20{

    string public constant nome = "jeremias";
    string public constant symbol = "JWB";
    uint8 public constant decimals = 18;

    mapping (address => uint256) balances;
    mapping (address => mapping (address =>uint256)) allowed;
    
    uint256 totalSuplay_ = 10 ether;

    constructor(){
        balances[msg.sender] = totalSuplay_;
    }
